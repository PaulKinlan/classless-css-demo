...
const render = (currentFramework) => {
  ...
  <body>
	<h1>Welcome to Classless CSS Demo using "<a href="${frameworks[currentFramework].siteUrl}">${frameworks[currentFramework].name}"</a></h1>
	...
	<h2>Images</h2>
	<figure>
    <img src="http://placekitten.com/g/900/500" alt="placeholder image 900 pixels wide by 500 pixels tall">
